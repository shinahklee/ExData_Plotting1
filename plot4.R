...
plot(data$Date_and_Time, data$Global_active_power, type="l", main="", xlab = "", ylab ="Global Active Power")
...
plot(data$Date_and_Time, data$Global_reactive_power, type="l", main="", xlab="datetime", ylab="Gloabl_reactive_power")
